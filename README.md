# Insurance One-Word Domains (9,295)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-9%2C299%20rows-8250df">
...
Daily-updated dataset of insurance one-word domains from Unique Domains.

> **Note:** this repository currently mirrors the full live catalog for this exact search.
> Unique Domains counts can still change as the search refreshes.

**Public extract:** 9,299 rows · **Live catalog:** 9,295 domains
...
- `insurance.csv` — public CSV extract (9,299 rows)
- `insurance.json` — public JSON extract (9,299 rows)
...
df = pd.read_csv("https://raw.githubusercontent.com/UniqueDomains/insurance-oneword-domains/main/insurance.csv")
print(df.head())
```
...
| ----------------------- | ------------------------------------------------ |
| 9,299-row public sample | 9,295 live domains                               |
...
> Unique Domains. *Insurance One-Word Domains*. Version 2026-04-12. Public GitHub extract for the exact Unique Domains search represented by this repository.
